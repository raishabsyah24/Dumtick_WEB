...
import { FieldValues, FormStateProxy, FieldErrors, OnSubmit, ElementLike, ValidationOptions, FieldName, FieldValue, ManualFieldError, MultipleFieldErrors } from './types';
...
export interface FormContextValues<FormValues extends FieldValues = FieldValues> {
    ...
    watch(fields: FieldName<FormValues>[] | string[], defaultValues?: Partial<FormValues>): Partial<FormValues>;
    watch(fieldNames?: FieldName<FormValues> | FieldName<FormValues>[] | {
        nest: boolean;
    }, defaultValue?: string | Partial<FormValues>): FieldValue<FormValues> | Partial<FormValues> | string | undefined;
