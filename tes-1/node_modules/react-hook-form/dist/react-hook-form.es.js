...
import { useState as useState$1, useRef as useRef$1, useEffect as useEffect$1, isValidElement, cloneElement, createElement, createContext, useContext, Fragment } from 'react';
...
const Controller = (_a) => {
    var { name, rules, as: InnerComponent, onChange, onBlur, onChangeName = VALIDATION_MODE.onChange, onBlurName = VALIDATION_MODE.onBlur, defaultValue, control: { defaultValues, fields, setValue, register, unregister, errors, mode: { isOnSubmit, isOnBlur }, reValidateMode: { isReValidateOnBlur, isReValidateOnSubmit }, formState: { isSubmitted }, } } = _a, rest = __rest(_a, ["name", "rules", "as", "onChange", "onBlur", "onChangeName", "onBlurName", "defaultValue", "control"]);
